...
#define protocol_Layer_init_default              {{{NULL}, NULL}, 0, {protocol_FadeColor_init_default}}
...
#define protocol_Layer_init_zero                 {{{NULL}, NULL}, 0, {protocol_FadeColor_init_zero}}
...
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,sectionsWaveColor,payload.sectionsWaveColor),   3) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,sectionsColor,payload.sectionsColor),   4) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,singleColor,payload.singleColor),   5) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,switchColor,payload.switchColor),   6) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,blinkMask,payload.blinkMask),  40) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,invertMask,payload.invertMask),  41) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,pulseSawtoothMask,payload.pulseSawtoothMask),  42) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,pulseMask,payload.pulseMask),  43) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,sawtoothMask,payload.sawtoothMask),  44) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,sectionsWaveMask,payload.sectionsWaveMask),  45) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,sectionsMask,payload.sectionsMask),  46) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,starsMask,payload.starsMask),  47) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,waveMask,payload.waveMask),  48)
