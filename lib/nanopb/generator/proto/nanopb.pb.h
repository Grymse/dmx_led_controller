...
#ifndef PB_GENERATOR_PROTO_NANOPB_PB_H_INCLUDED
#define PB_GENERATOR_PROTO_NANOPB_PB_H_INCLUDED
#include <pb.h>
...
#define NanoPBOptions_label_override_ENUMTYPE google_protobuf_FieldDescriptorProto_Label
#define NanoPBOptions_enum_intsize_ENUMTYPE IntSize


/* Initializer values for message structs */
#define NanoPBOptions_init_default               {false, 0, false, 0, false, FieldType_FT_DEFAULT, false, true, false, false, false, false, false, IntSize_IS_DEFAULT, false, false, false, 0, false, false, false, false, false, false, false, false, false, 0, false, false, false, false, false, TypenameMangling_M_NONE, {{NULL}, NULL}, {{NULL}, NULL}, false, DescriptorSize_DS_AUTO, false, false, false, false, false, false, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, _google_protobuf_FieldDescriptorProto_Type_MIN, false, true, false, FieldType_FT_CALLBACK, {{NULL}, NULL}, false, _google_protobuf_FieldDescriptorProto_Label_MIN, false, false, false, true, false, IntSize_IS_DEFAULT, false, false}
#define NanoPBOptions_init_zero                  {false, 0, false, 0, false, _FieldType_MIN, false, 0, false, 0, false, 0, false, _IntSize_MIN, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, _TypenameMangling_MIN, {{NULL}, NULL}, {{NULL}, NULL}, false, _DescriptorSize_MIN, false, 0, false, 0, false, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, _google_protobuf_FieldDescriptorProto_Type_MIN, false, 0, false, _FieldType_MIN, {{NULL}, NULL}, false, _google_protobuf_FieldDescriptorProto_Label_MIN, false, 0, false, 0, false, _IntSize_MIN, false, 0}
...
#define NanoPBOptions_initializer_tag            30
#define NanoPBOptions_label_override_tag         31
#define NanoPBOptions_enum_validate_tag          32
#define NanoPBOptions_discard_unused_automatic_types_tag 33
#define NanoPBOptions_enum_intsize_tag           34
#define NanoPBOptions_discard_deprecated_tag     35
...
X(a, CALLBACK, OPTIONAL, STRING,   initializer,      30) \
X(a, STATIC,   OPTIONAL, UENUM,    label_override,   31) \
X(a, STATIC,   OPTIONAL, BOOL,     enum_validate,    32) \
X(a, STATIC,   OPTIONAL, BOOL,     discard_unused_automatic_types,  33) \
X(a, STATIC,   OPTIONAL, UENUM,    enum_intsize,     34) \
X(a, STATIC,   OPTIONAL, BOOL,     discard_deprecated,  35)
#define NanoPBOptions_CALLBACK pb_default_field_callback
#define NanoPBOptions_DEFAULT (const pb_byte_t*)"\x20\x01\x28\x00\x30\x00\x40\x00\x50\x00\x58\x00\x60\x00\x68\x00\x78\x00\x80\x01\x00\xa8\x01\x00\xb0\x01\x00\xb8\x01\x00\xd8\x01\x01\xe0\x01\x01\xe8\x01\x01\xf8\x01\x01\x80\x02\x00\x88\x02\x01\x98\x02\x00\x00"
